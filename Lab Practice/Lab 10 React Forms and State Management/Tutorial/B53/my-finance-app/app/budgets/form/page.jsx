...
export default function BudgetFormPage() {
    ...
    // TODO 10c: Replace with isEdit ? updateBudgetAction : createBudgetAction
        ...
        <main className="page">
            ...
            <div className="form-container">
                ...
                <form action={formAction}>
                    {isEdit && <input type="hidden" name="id" defaultValue={budget.id} />}
                    ...
                    <div className="form-group">
                        ...
                        {error?.spent && <p className="error-message">{error.spent}</p>}
                    </div>
                    <div className="form-group">
