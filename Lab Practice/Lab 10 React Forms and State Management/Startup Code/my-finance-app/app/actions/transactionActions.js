...
export async function createTransactionAction(formData) {
    ...
    log("createTransactionAction called with formData:", formData);
}
...
export async function updateTransactionAction(formData) {
    ...
    log("updateTransactionAction called with formData:", formData);
...
export async function deleteTransactionAction(id) {
    ...
    log("deleteTransactionAction called with id:", id);
